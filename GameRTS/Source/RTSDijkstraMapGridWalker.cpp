...
/************************************************************************************************************************/
  ...
  RTSDijkstraMapGridWalker::RTSDijkstraMapGridWalker( RTSTiledMap *pMap ) : RTSMapGridWalker( pMap )
  ...
  void RTSDijkstraMapGridWalker::PathRender()
  {
    int32 tmpx;
    int32 tmpy;
  ...
  WALKSTATE::E RTSDijkstraMapGridWalker::Update()
